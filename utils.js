...
const Utils = (function(){
  ...
  const TASK_TYPES = ['Lecture', 'Module', 'DPP', 'Revision', 'PYQ', 'HW'];
  ...
  function parseTaskTypes(typeStr){
    if(!typeStr) return [];
    const synonyms = { 'lecture':'Lecture', 'module':'Module', 'dpp':'DPP', 'revision':'Revision', 'pyq':'PYQ', 'hw':'HW', 'homework (hw)':'HW' };
